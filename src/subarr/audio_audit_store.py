...
class AudioAuditStore:
    ...
    def _row(self, r: sqlite3.Row) -> AuditFinding:
        try:
            heard = json.loads(r["languages_heard"] or "[]")
        ...
        return AuditFinding(
            ...
            status=r["status"],
            languages_heard=heard if isinstance(heard, list) else [],
