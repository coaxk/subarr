...
[![tests](https://img.shields.io/badge/tests-2365_python_%2B_289_frontend-22d3ee)](https://github.com/coaxk/subarr/actions/workflows/ci.yml)
...
> **Next fifteen minutes:** [docs/first-run.md](./docs/first-run.md) says what the wizard asks for, what to have ready, and what a finished setup looks like.
