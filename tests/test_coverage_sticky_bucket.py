...
def _body():
    return {
        "items": [
            ...
            {
                "media_type": "episode",
                "verification_state": "probe_failed",
                "embedded_en": "EN",
                "has_sub_on_disk": True,
                "bazarr": {"missing_subtitles": ["nl"]},
            },
...
def test_unverified_rows_are_sticky_under_filters():
    ...
    out = _apply_filters_and_pack(
        _body(),
        now=0.0,
        hide_embedded_en=True,
        hide_stale_disk=True,
        hide_english_audio=True,
        hide_pending_download=True,
...
def test_verification_bucket_counts_exposed():
    ...
    out = _apply_filters_and_pack(
        _body(),
        now=0.0,
        hide_embedded_en=False,
        hide_stale_disk=False,
        hide_english_audio=False,
        hide_pending_download=False,
        only_wanted_langs="",
    )
